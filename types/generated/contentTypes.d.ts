...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    download: Attribute.Component<'shared.download'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    body: Attribute.Component<'text.content', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    ...
    phone: Attribute.Component<'shared.phone', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    price: Attribute.Component<'event.pricing'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    contact: Attribute.Component<'event.contact', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    description: Attribute.Component<'text.description'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    tip: Attribute.Component<'text.description'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiImpressumImpressum extends Schema.SingleType {
  ...
  attributes: {
    ...
    founding: Attribute.Date;
    number: Attribute.String;
    judiciary: Attribute.String;
    content_accountable: Attribute.String;
    technical_accountable: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSeedSeed extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::seed.seed', 'title'> & Attribute.Required;
    botanic: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    details: Attribute.Component<'seed.details'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::seed.seed', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::seed.seed', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    localizations: Attribute.Relation<
      'api::seed.seed',
      'oneToMany',
...
export interface ApiShowcaseShowcase extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: 'Pflanze des Monats';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSupportSupport extends Schema.SingleType {
  ...
  attributes: {
    ...
    iban_eur: Attribute.String;
    iban_ron: Attribute.String;
    cif: Attribute.String;
    cui: Attribute.String;
    swift: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
